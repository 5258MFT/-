...
# 创建文件对象，所有数据都存入kaifa_jobs2.csv
f = open('./kaifa/kaifa_jobs2.csv', mode='w', encoding='utf-8', newline='')
# 字典写入方法
...
for url in urls:
    ...
    for page in range(1, 11):
        ...
        # 这部分是相关设置，可以自行更改相关关键词
        data = {"data":{"mainSearchPcConditionForm":{"city":"410","dq":"410","pubTime":"","currentPage":str(page),"pageSize":40,"key":"软件开发","suggestTag":"","workYearCode":"0","compId":"","compName":"","compTag":"","industry":"","salary":"","jobKind":"","compScale":"","compKind":"","compStage":"","eduLevel":""},"passThroughForm":{"scene":"condition","skId":"hckpqfp7kzk1nmqr4ucdq7p9v1lilcg8","fkId":"ljsgavdm4f2tz8w9htpt985czntc84zb"}}}
        try:
